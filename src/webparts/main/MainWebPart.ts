...
import { webAbsoluteUrl$ } from "../../services/context";
import { msGraphClientFactory$ } from "../../services/graphAPI";
...
export default class MainWebPart extends BaseClientSideWebPart<IMainWebPartProps> {
  ...
  protected onInit(): Promise<void> {
    ...
    msGraphClientFactory$.next(this.context.msGraphClientFactory);
